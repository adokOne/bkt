...
function inputCheck(el) { //extend Checkboxes
  ...
  el.dummy.ref = el;
  if(isIE == false) {el.dummy.style.left = (findPosX(el) - 365) + 'px'; el.dummy.style.top = (findPosY(el) - 27 ) + 'px';}
  else {el.dummy.style.left = (findPosX(el) - 365) + 4 + 'px'; el.dummy.style.top = findPosY(el) + 4 + 'px';}
  el.dummy.onclick = function() {
    if(!this.ref.checked) {
      this.ref.checked = true;
...
function selects(el) { //extend Selects
  ...
  el.dummy.style.left = (findPosX(el) - 365) + 'px';
  el.dummy.style.top = (findPosY(el) - 27) + 'px';
