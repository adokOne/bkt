...
<?php if(Kohana::config("core.new_baner")):?>


<div id="baner_slide">
<?php foreach(ORM::factory("baner")->find_all() as $baner):?>
<div class="baner_item">
<div id="change_fl" >
	<img alt="<?php echo $baner->alt ?>" title="<?php echo $baner->title ?>" src="/upload/baners/<?php echo $baner->id?>/pic_600.jpg" width="601" height="288"/>
</div>

<div id="bottom_menu"></div>
<div id="button_k">
	<a href="<?php echo $baner->link ?>">
		<span><?php echo $baner->link_text ?></span>
	</a>
</div>
<p id="f1"><?php echo $baner->desc ?><span>&nbsp;&nbsp;&gt;&gt;&gt;</span></p>
</div>
<?php endforeach;?>
...
<div id="leftcol" style="height: 100px;">
	<img alt="<?php echo Kohana::config("core.baner_desc_alt")?>" title="<?php echo Kohana::config("core.baner_desc_title")?>" src="/upload/baners/0/pic_870.jpg" id="my_big_pic">
</div>
