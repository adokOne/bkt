<div class="page_edit row-fluid sortable ui-sortable">
				<div class="box span12">
					<div style="height: 30px;" class="box-header" data-original-title="">
						<h2 style="margin-right: 20px;"><i class="icon-edit"></i><span class="break"></span>Новина</h2>
					...
					<div class="box-content">
						<form class="page_save form-horizontal">
						  <fieldset>
							...
							<div class="control-group _0 _1">
							  <label class="control-label" for="typeahead">Відображати на головній?</label>
							  <div class="controls">
							  	<select name="show_on_main">
							  		<option value="1">TAK</option>
							  		<option value="0">HI</option>
							  	</select>
							  </div>
							...
							<div class="control-group  _0 _1">
							  <label class="control-label" for="typeahead">Коментарі</label>
							  <div class="controls">
								<a href="/admin/blog/comments/<?php echo $ne_id?>">Переглянути комментарі</a>
							  </div>
							</div>
						  	<?php foreach($langs as $id=>$lang):?>
