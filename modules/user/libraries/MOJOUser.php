...
class MOJOUser {
	...
	public static function processAvatar($filename, $user_id,$unlink=true,$folder='upload/avatars/',$sizes = array()){
		$sizes = count($sizes) < 1 ? Kohana::config('user.avatars') : $sizes;
